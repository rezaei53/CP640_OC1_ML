...
#CSCO, INTC, MSFT, AAPL, TXN. They're fairly related, of similar size, and we can donwload 10+ years of data for each.
...
#We'll use the base cor function in R. It basically compares two vectors AAPLying covariances and standard deviations
...
legend(x='bottomleft', legend=c("MSFT", "INTC", "AAPL", "TXN", "CSCO"), col=c("darkgreen","red", "blue", "yellow", "pink"), lwd=1, lty=c(0,0), 
        pch=c(3,3))
